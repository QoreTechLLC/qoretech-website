...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Fast, scalable MVP development powered by modern technologies and efficient execution. Launch in weeks, not months.",
  },
  {
    icon: Cpu,
    title: "Modern, future-proof tech",
    description:
      "No legacy frameworks, no vendor lock-in, no technical debt from day one. Every project runs on current best-in-class stack.",
  },
  {
    icon: Users,
    title: "Personalized approach",
    description:
      "You work directly with senior engineers. We learn your domain and build like co-founders — not a rotating cast of contractors.",
  },
  {
    icon: TrendingUp,
    title: "Built to scale",
    description:
      "Architecture decisions that make sense at 100 users and still work at 100,000. We think ahead so you never need to rearchitect.",
  },
  {
    icon: HeartHandshake,
    title: "Long-term partnership",
    description:
      "We don't disappear after launch. Retainer support, iterative improvements, and ongoing monitoring — we stay in your corner.",
  },
];
  ...
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <GlowOrb
        color="neon"
        size="lg"
        className="top-0 right-0 opacity-[0.06]"
      />
